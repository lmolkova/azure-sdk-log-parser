...
public class CsvLogParserOptions extends LogParserOptions {
    public static final String COMMAND_NAME = "csv";
    @Parameter(names = {"-l", "--layout"}, description = "Layout of each log line. Each parameter name is enclosed "
            ...
            order = 1, converter = CsvLogParserOptions.LayoutConverter.class)
